...
public class RegisterRequestDTO {
    ...
    @Pattern(
        regexp = "^(?=.*[a-z])(?=.*[A-Z])(?=.*\\d)(?=.*[@$!%*?&]).+$",
        message = "Password debe contener al menos una minúscula, una mayúscula, un número y un carácter especial"
    )
    ...
    // Backwards-compatible convenience ctor (used in older tests)
    public RegisterRequestDTO(String username, String email, String password) {
        this(username, email, password, "+573000000000");
    }
